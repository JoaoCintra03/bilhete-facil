  ...
  return (
    ...
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.description}>
            Esta é a descrição detalhada do evento de ID {id}. Aqui você pode colocar todas as informações sobre atrações, cronograma, regras e detalhes importantes que o usuário precisa saber antes de participar.
          </Text>
        </View>
      </ScrollView>
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          style={[styles.button, { backgroundColor: noCarrinho ? '#34C759' : primaryColor }]}
          onPress={async () => {
            if (noCarrinho) {
